...
with st.sidebar:
    ...
    with st.expander("📖 ¿Cómo obtener tu API Key?", expanded=not bool(api_key)):
        st.markdown("""
<div class="step-box">
...
<div class="step-box">
<strong>Paso 4:</strong> Pégala en el campo de arriba ☝️
</div>
        """, unsafe_allow_html=True)
        st.info("💡 El plan **gratuito** incluye acceso básico a la API con créditos limitados.")
